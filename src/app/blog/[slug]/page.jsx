    ...
    <div className={styles.container}>
      <div className={styles.top}>
        ...
        <div className={styles.imageContainer}>
          <Image src="https://juan-sesu-ecommerce.s3.amazonaws.com/1686396482134.jpg" alt="" fill={true} className={styles.image} />
        </div>
      </div>
      <div className={styles.content}>
        <p className={styles.text}>
          ...
          Molestias, cupiditate.<br/><br/>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta velit
          eaque, omnis tempore, accusamus dolor nam hic eveniet maiores commodi
          consectetur expedita labore vero est animi, repellendus inventore?
          Molestias, cupiditate.      Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta velit
          eaque, omnis tempore, accusamus dolor nam hic eveniet maiores commodi
          consectetur expedita labore vero est animi, repellendus inventore?
